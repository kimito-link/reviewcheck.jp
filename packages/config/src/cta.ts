...
export const CTAS: Record<string, Cta> = {
  ...
  monitoring: {
    ...
    label: "月次モニタリングを始める",
    href: "https://partner.reverse-re-birth-hack.com/monitor?plan=reviewcheck&tier=bamboo&from=check&utm_source=reviewcheck&utm_medium=report&utm_campaign=monitoring",
    emphasis: "cta",
  },
  suggest: {
    key: "suggest",
